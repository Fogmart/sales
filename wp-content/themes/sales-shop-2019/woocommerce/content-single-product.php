...
<div  class="product page" id="product-<?php the_ID(); ?>" <?php wc_product_class( '', $product ); ?>>
    <div class="container">
        ...
        <?php 
            $saller = ss_get_product_seller($product_ID); 
            $saller_ID = $saller->id;
            $city = ss_get_seller_city($saller_ID); 
        ?>
            ...
            <div class="col-md-9">
                    <div class="product__main product__block">
                            <div class="product__main__top">
                                <div class="card__name"><?php echo $saller->name; ?></div>
                                    <div class="card__location"><?php echo $city->country . ", " . $city->name; ?></div>
                            </div>

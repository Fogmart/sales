					...
					<div class="dashboard__block">
						...
						<div class="dashboard__numbers">
							<div class="dashboard__number">
								...
								<div class="dashboard__number__text"><?= count($found_reports) ?></div>
							</div>
							<div class="dashboard__number">
						...
						<table class="dashboard__vouchers__table">
							...
							<?php foreach ($found_reports as $order_id => $coupons) : ?>
								<?php foreach ($coupons as $one) : ?>
									...
									$product = $order_item_product->get_product();
									$product_terms = get_the_terms($product->get_id(), 'product_cat') ?: array();
									...
									<tr>
										<td>
											<div class="vouchers__text"><?= $product->name ?></div>
										</td>
										<td>
											<div class="vouchers__text"><?= implode(', ', $product_term_names) ?></div>
										</td>
										<td>
											<div class="vouchers__text"><?= $product->get_total_sales() ?></div>
										</td>
										<td>
